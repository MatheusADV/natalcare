...
urlpatterns = [
    ...
    path('clinc/', clin_dados.as_view(), name="clinc"),
    path('clinu/<int:id>/', clinusu.as_view(), name="clinu"),
    ...
    path('prochatusu/<int:id>/', prochatusu.as_view(), name="prochatusu"),
    path('chatusu/', chatusu.as_view(), name="chatusu"),
